...
gantt
    ...
    Этап 2. Kademlia DHT k-bucket routing lookup    :done, s2, 2026-09-25, 2d
    Этап 3. Записи DHT репликация псевдонимы        :active, s3, 2026-09-27, 2d
    section Безопасность
    Этап 4. Протокол AKE и защита сессий            :s4, 2026-09-29, 3d
    section Туннели и Приложения
    Этап 5. Построение туннелей от 3 хопов          :s5, 2026-10-02, 3d
    Этап 6. Прикладной сервис сообщений и файлов    :s6, 2026-10-05, 3d
    section Тестирование и Анализ
    Этап 7. Развертывание сети N21 Docker           :s7, 2026-10-08, 2d
    Этап 8. Эксперименты сбор метрик netem отчет    :s8, 2026-10-10, 4d
```
...
| **Этап 2** | Kademlia DHT | KBucket LRU, RoutingTable 256, async lookup $\alpha=3$, $k=4$, bootstrap self-lookup, тесты E2-1..E2-8 | **Выполнен** |
| **Этап 3** | Записи DHT и псевдонимы | `STORE`, `FIND_VALUE`, NodeRecord, репликация $R=3$, TTL, алиасы | **В разработке** |
