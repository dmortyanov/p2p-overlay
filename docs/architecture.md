...
```mermaid
gantt
    title План реализации защищённой P2P оверлейной сети
    dateFormat  YYYY-MM-DD
    section Базис
    Этап 1: Сетевой транспорт, кадры, идентичность, CMake       :done, s1, 2026-09-14, 2026-09-14
    Архитектурная спецификация (docs/architecture.md)          :active, s_arch, 2026-09-25, 2026-09-25
    section DHT и Маршрутизация
    Этап 2: Kademlia DHT (k-bucket, routing, lookup, RPC)      : s2, 2026-09-26, 2026-09-28
    Этап 3: Записи DHT (NodeRecord, репликация, псевдонимы)    : s3, 2026-09-29, 2026-09-30
    section Безопасность
    Этап 4: Собственный протокол AKE и защита сессий           : s4, 2026-10-01, 2026-10-03
    section Туннели и Приложения
    Этап 5: Построение и перестроение туннелей (>=3 хопа)      : s5, 2026-10-04, 2026-10-06
    Этап 6: Прикладной сервис сообщений и файлов               : s6, 2026-10-07, 2026-10-09
    section Тестирование и Анализ
    Этап 7: Развёртывание сети N=21 узлов в Docker Compose     : s7, 2026-10-10, 2026-10-11
    Этап 8: Эксперименты, сбор метрик, netem, отчёт            : s8, 2026-10-12, 2026-10-14
```
